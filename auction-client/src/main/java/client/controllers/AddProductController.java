...
public class AddProductController {
    ...
    public void setEditData(Item item) {
        ...
        } else if (cat != null && cat.toUpperCase().contains("VEHICLE")) {
            cmbCategory.getSelectionModel().select("Phương tiện (Vehicle)");
    ...
    private void handleSave() {
        try {
            ...
            if (category.contains("Art")) {
                ...
                resultItem = new Vehicle(id, name, price);
                resultItem.setCategory("VEHICLE");
            }
